...
public class TrioTester {
	...
	public static void main(String[] args) {
		...
		// UN-COMMENT WHEN YOU HAVE UPDATED THE CLASS HEADER TO ADD GENERICS AND WRITTEN
		// BOTH CONSTRUCTORS
		...
		// each line should cause a compiler error because the generic types do not
		// match
		...
		System.out.println(
				"------------------------------TESTING TOSTRING METHOD AND ONE-PARAMETER CONSTRUCTOR------------------------------");
		 ...
		 * 
		 * 
		 * System.out.println("\n-----Getter/Setter tests: " + (passGetterSetter ?
		 * "Passed" : "*****AT LEAST ONE TEST FAILED*****"));
		 ...
		 * );
		 * System.out.println(numberTrio);
		 * if(numberTrio.getItem1().intValue()!=43 ||
		 * numberTrio.getItem2().intValue()!=43 || numberTrio.getItem3().intValue()!=43)
		 * {
		 ...
		 * because the generic types do not match
		 ...
		 * testHasDuplicates(new Trio<Integer>(3, 3, 5), true,
		 * "items 1 and 2 are duplicates");
		 * testHasDuplicates(new Trio<Integer>(3, 4, 4), true,
		 * "items 2 and 3 are duplicates");
		 * testHasDuplicates(new Trio<Integer>(3, 4, 3), true,
		 * "items 1 and 3 are duplicates");
		 * testHasDuplicates(new Trio<Integer>(4, 4, 4), true,
		 * "all three items are duplicates");
		 * testHasDuplicates(new Trio<String>(new String("a"), new String("a"), new
		 * String("a")), true,
		 * "all three items are duplicates and items are Objects (Strings)");
		 * 
		 * System.out.println("\n-----hasDuplicates tests: " + (passHasDuplicates ?
		 * "Passed" : "*****AT LEAST ONE TEST FAILED*****"));
		 */
		 ...
		 * wordTrio = new Trio<String>(new String("a"), new String("a"), new
		 * String("a"));
		 * testCount(wordTrio, "a", 3);
		 * testCount(wordTrio, new String("a"), 3);
		 * testCount(wordTrio, "A", 0);
		 * 
		 * System.out.println("\n-----count tests: " + (passCount ? "Passed" :
		 * "*****AT LEAST ONE TEST FAILED*****"));
		 */

		// UN-COMMENT WHEN YOU HAVE WRITTEN YOUR EQUALS METHOD
		// IMPORTANT NOTE: YOU ALSO NEED TO UN-COMMENT TWO TESTER METHODS FOR THIS TO
		// RUN
		/*
		 * System.out.
		 ...
		 * // parameter 2: the Trio object to pass in to the equals method as a
		 * parameter
		 * // parameter 3: the expected result (true if the Trios are equivalent, false
		 * otherwise)
		 * // parameter 4: a description of the test
		 * testEquals(new Trio<String>(new String("aa"), new String("bb"), new
		 * String("cc")),
		 * new Trio<String>(new String("aa"), new String("bb"), new String("cc")),
		 * true,
		 * "no duplicates, same items in same order; items are objects (type String)");
		 * 
		 ...
		 * true,
		 * "no duplicates, same items in same order; items are objects (type Integer)");
		 * 
		 ...
		 * extraEqualsTests();
		 * 
		 * System.out.println("\n-----equals tests: " + (passEquals ? "Passed" :
		 * "*****AT LEAST ONE TEST FAILED*****"));
		 */
	...
	/*
	 * public static <T> void testGetterSetter(Trio<T> trio, int position, T
	 * expectedValue) {
	...
	/*
	 * public static <T> void testHasDuplicates(Trio<T> trio, boolean
	 * expectedResult, String testDescription) {
	 * String trioDescription = "(" + trio.getItem1() + ", " + trio.getItem2() +
	 * ", " + trio.getItem3() + ")";
	...
	/*
	 * public static <T, S> void testEquals(Trio<T> trio1, Trio<S> trio2, boolean
	 * expectedResult, String testDescription) {
	 * String trio1Description = "(" + trio1.getItem1() + ", " + trio1.getItem2() +
	 * ", " + trio1.getItem3() + ")";
	 * String trio2Description = "(" + trio2.getItem1() + ", " + trio2.getItem2() +
	 * ", " + trio2.getItem3() + ")";
	 ...
	 * trio1Description = "(" + trio1.getItem1() + ", " + trio1.getItem2() + ", " +
	 * trio1.getItem3() + ")";
	 * trio2Description = "(" + trio2.getItem1() + ", " + trio2.getItem2() + ", " +
	 * trio2.getItem3() + ")";
	 ...
	 * if(!(numberTrio1.getItem1()==1 && numberTrio1.getItem2()==2 &&
	 * numberTrio1.getItem3()==3)) {
	 * passEquals = false;
	 * System.out.
	 * println("\n**********TEST FAILED IN EXTRA EQUALS TEST: invoking object changed"
	 * );
	 * }
	 * if(!(numberTrio2.getItem1()==3 && numberTrio2.getItem2()==2 &&
	 * numberTrio2.getItem3()==1)) {
	 * passEquals = false;
	 * System.out.
