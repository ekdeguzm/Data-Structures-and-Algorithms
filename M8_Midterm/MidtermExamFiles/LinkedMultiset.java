...
public class LinkedMultiset<T> implements Multiset<T> {
	...
	public void duplicateTheContents() {
		if (isEmpty()) {
			return;
		}
	...
	public T randomRemove() {
		...
		// removeNode(current); // invoke this instead of the line below if you want to
		// use the practice version of removing the actual ndoe
